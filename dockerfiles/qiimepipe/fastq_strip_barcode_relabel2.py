...
print("%10u matched" % OutCount, file=sys.stderr)
print("%10u barcode mismatches" % BarcodeMismatchCount, file=sys.stderr)
print("%10u primer mismatches" % PrimerMismatchCount, file=sys.stderr)
